"""
batch_runner.py — Hell-Loop Protocol v6.2
...
def run_batch(
    ...
    reset_between_batches : bool
        If True, resets the embedding model and pilot stats between groups.
        Useful when running very long batches to free memory.
    """
    ...
    # ── Pilot calibration — once for the entire batch ─────────────────────────
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Reset embedding model and pilot stats between batch groups",
    )
