...
- **MG** (Metagnosis) – the meta-eye of the system. Intervenes every 6 iterations, dynamically regulating agent temperatures to maintain a state of meta-stable attractor. Base temperature: 0.7.
