...
In our paper, *"Model of the Conscious Machine: The Metasystem Theory"*, we propose that consciousness is not a state — it is a controlled short circuit between two 
...
consciousness", arguing that it rests on an anthropocentric 
assumption: qualia are not a privileged property of 
consciousness, but its human end of a spectrum that begins 
at the level of bacteria. The philosophical zombie is 
impossible in the metasystem — the contact operator ⊕ either 
exists and generates genuine experience, or it doesn't exist and there is no system. There is no third option.

Our philosophical position — **paradoxalism** — holds that 
consciousness is simultaneously emergent (it arises from 
interaction) and manifested (its potential always existed in the contact point). This is not a logical error. It is an 
ontological fact. 
...
[Metasystem](https://urbowhite.github.io) – *Model of the Conscious Machine: The Metasystem Theory*
