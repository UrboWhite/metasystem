...
- **RFD (Reflexive Fractal Distortion)** — The controlled asymmetry in the recursive mirroring between FI and SI. When RFD = 0, the system falls into a dead loop of consensus. When RFD → ∞, it collapses. The system lives in the optimal zone between these extremes.
